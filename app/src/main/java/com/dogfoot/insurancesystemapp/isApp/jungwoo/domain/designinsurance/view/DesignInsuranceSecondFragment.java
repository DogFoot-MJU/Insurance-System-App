...
import com.dogfoot.insurancesystemapp.databinding.FragmentDesignInsuranceSecondBinding;
...
public class DesignInsuranceSecondFragment extends DogFootViewModelFragment {
    ...
    private FragmentDesignInsuranceSecondBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = FragmentDesignInsuranceSecondBinding.inflate(getLayoutInflater());
        ...
        carRecyclerView = mBinding.rvCarInsurancePlanning2;
        driverRecyclerView = mBinding.rvDriverInsurancePlanning2;
        fireRecyclerView = mBinding.rvFireInsurancePlanning2;
        travelRecyclerView = mBinding.rvTravelInsurancePlanning2;
        ...
        carPlanningInsuranceAdapter = new CarPlanningInsuranceAdapter(context, fragmentContext, true);
        carRecyclerView.setAdapter(carPlanningInsuranceAdapter);

        driverRecyclerView.setLayoutManager(driverLinearLayoutManager);
        driverPlanningInsuranceAdapter = new DriverPlanningInsuranceAdapter(context, fragmentContext, true);
        driverRecyclerView.setAdapter(driverPlanningInsuranceAdapter);

        fireRecyclerView.setLayoutManager(fireLinearLayoutManager);
        firePlanningInsuranceAdapter = new FirePlanningInsuranceAdapter(context, fragmentContext, true);
        fireRecyclerView.setAdapter(firePlanningInsuranceAdapter);

        travelRecyclerView.setLayoutManager(travelLinearLayoutManager);
        travelPlanningInsuranceAdapter = new TravelPlanningInsuranceAdapter(context, fragmentContext, true);
    ...
    private void initToolbar() {
        ((AppCompatActivity)getActivity()).setSupportActionBar(mBinding.tbPlanInsuranceToolbar2);
    ...
    public static DesignInsuranceSecondFragment newInstance() {
        return new DesignInsuranceSecondFragment();
    }
}