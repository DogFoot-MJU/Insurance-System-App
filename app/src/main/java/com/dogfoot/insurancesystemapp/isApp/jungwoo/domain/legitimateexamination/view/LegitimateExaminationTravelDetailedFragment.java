...
import com.dogfoot.insurancesystemapp.databinding.FragmentLegitimateExaminationTravelDetailedBinding;
...
public class LegitimateExaminationTravelDetailedFragment extends DogFootViewModelFragment {

    private FragmentLegitimateExaminationTravelDetailedBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = FragmentLegitimateExaminationTravelDetailedBinding.inflate(getLayoutInflater());
    ...
    private void initData() {
        ...
        RetrofitTool.getAPIWithAuthorizationToken(token)
                .getTravelLegitimateExaminationDetailed(Long.valueOf(id)).enqueue(new Callback<TravelLegitimateExaminationResponse>() {
            @Override
            public void onResponse(Call<TravelLegitimateExaminationResponse> call,
                                   Response<TravelLegitimateExaminationResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    mBinding.tvLegitimateCustomerSafetyRank.setText(String.valueOf(response.body().getSafety_rank()));
            ...
            @Override
            public void onFailure(Call<TravelLegitimateExaminationResponse> call, Throwable t) {
            }
        });
    }
    ...
    private void init() {
        mBinding.btnContractApprove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String token = constant.getDataset().get(DogFootEntity.EDogFootData.AUTHORIZATION);
                RetrofitTool.getAPIWithAuthorizationToken(token)
                        .approveLegitimateExaminationTravel(Long.valueOf(id)).enqueue(new Callback<Void>() {
                    @Override
        ...
        mBinding.btnContractReject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String token = constant.getDataset().get(DogFootEntity.EDogFootData.AUTHORIZATION);
                RetrofitTool.getAPIWithAuthorizationToken(token)
                        .rejectLegitimateExaminationTravel(Long.valueOf(id)).enqueue(new Callback<Void>() {
                    @Override
                    public void onResponse(Call<Void> call,
                                           Response<Void> response) {
                        if (response.isSuccessful()) {
    ...
    private void initToolbar() {
        ((AppCompatActivity)getActivity()).setSupportActionBar(mBinding.tbLegitimateExaminationTravelToolbar);
    ...
    public static LegitimateExaminationTravelDetailedFragment newInstance() {
        return new LegitimateExaminationTravelDetailedFragment();
    }
}